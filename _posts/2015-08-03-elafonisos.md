...
![]({{ site.baseurl }}/images/{{ page.slug }}/road.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/simos.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/boat.jpg)

# Company was awesome

![]({{ site.baseurl }}/images/{{ page.slug }}/company.jpg)

There was cockfighting involved (and asking for mercy).

![]({{ site.baseurl }}/images/{{ page.slug }}/cockfight.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/sunset.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/moon.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/port.jpg)
