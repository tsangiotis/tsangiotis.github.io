...
Recently a bunch of equipment made its way to my workbench and I’m invigorated! So I figured it’s high time we [continued]({{ site.baseurl }}/aircraft-design-the-nasa-way) our trip.
...
![]({{ site.baseurl }}/images/{{ page.slug }}/iris1.jpg)
...
The mystery now is how a quadcopter succeeds in that regard. Not significantly different from helicopters, quadcopters use four propellers and four motors which generate thrust in order to fly. Thrust is the force you use to beat gravity. Call me Yoda cause I will teach you how to use the force Luke! First lesson, *“from your sister, away get!”*

![]({{ site.baseurl }}/images/{{ page.slug }}/xkcd-quad.png)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/euler.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/example.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/yaw-mayhem.jpg)
...
![]({{ site.baseurl }}/images/{{ page.slug }}/yaw.jpg)
